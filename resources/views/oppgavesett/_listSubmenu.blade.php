        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="submenu">
                <ul class="nav navbar-nav">
                    ...
                    @endif
                    <li>
                        <a id="submenuitem2" href="{{ URL::route('oppgavesett.create') }}" data-toggle="tooltip" data-placement="bottom" data-container="body" title="Legg til oppgavesett"><span class="fa fa-plus"></span> Legg til oppgavesett</a>
                    </li>
                    <li>
