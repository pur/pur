...
<div role="tabpanel">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#inngaaendefaktura" aria-controls="inngaaendefaktura" role="tab" data-toggle="tab">Inngående faktura</a></li>
        <li role="presentation"><a href="#inngaaendekreditnota" aria-controls="inngaaendekreditnota" role="tab" data-toggle="tab">Inngående kreditnota</a></li>
        <li role="presentation"><a href="#utbetaling" aria-controls="utbetaling" role="tab" data-toggle="tab">Utbetaling</a></li>
    </ul>
