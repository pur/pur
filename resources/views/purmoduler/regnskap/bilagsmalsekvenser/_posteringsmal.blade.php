        ...
        <div class="form-group col-md-1 action-buttons">
            <div class="pull-right">
                @if($posteringsmal != null)
                    ...
                    <button type="submit" class="btn btn-default bekreft-slett" id="posteringsmal-{{$posteringsmal->id}}" data-toggle="tooltip" data-placement="top"
                ...
                @else
                    ...
                    <button type="submit" class="btn btn-default bekreft-slett" data-toggle="tooltip" data-placement="top"
                            data-container="body" title="Slett postering">
                        <span class="fa fa-trash"></span>
                    </button>
                @endif
