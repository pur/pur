	...
	inst.curValue = inst.prevValue + inst.curValue;
		...
		regionalOptions: { // Available regional settings, indexed by language/country code
			'': { // Default regional settings - English/US
				decimalChar: '.',
				buttonText: '...',
				buttonStatus: 'Åpne kalkulator',
				closeText: 'Lukk',
				closeStatus: 'Lukk kalkulatoren',
				useText: 'Bruk',
				useStatus: 'Bruk verdi',
				eraseText: 'Slett',
				eraseStatus: 'Slett verdi',
				backspaceText: '<–',
				backspaceStatus: 'Slett siste sifre',
				clearErrorText: 'CE',
				clearErrorStatus: 'Slett siste tall',
				clearText: 'C',
				clearStatus: 'Nullstill',
				memClearText: 'MC',
				memClearStatus: 'Slett minne',
				memRecallText: 'MR',
				memRecallStatus: 'Hent verdi fra minne',
				memStoreText: 'MS',
				memStoreStatus: 'Lagre verdi i minne',
				memAddText: 'M+',
				memAddStatus: 'Legg til verdi i minne',
				memSubtractText: 'M-',
				memSubtractStatus: 'Trekk fra verdi i minne',
				base2Text: 'Bin',
				base2Status: 'Konverter til binær',
				base8Text: 'Oct',
				base8Status: 'Konverter til oktal',
				base10Text: 'Dec',
				base10Status: 'Konverter til desimal',
				base16Text: 'Hex',
				base16Status: 'Konverter til heksadesimal',
				degreesText: 'Deg',
				degreesStatus: 'Konverter til grader',
				radiansText: 'Rad',
				radiansStatus: 'Konverter til redianer',
				isRTL: false
			}
		},
